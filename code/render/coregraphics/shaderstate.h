#ifndef COREGRAPHICS_SHADERSTATE_H
#define COREGRAPHICS_SHADERSTATE_H
//------------------------------------------------------------------------------
/**
...
const char* ParamToString(ShaderParam p);
/// convert string to parameter
ShaderParam StringToParam(const Util::String& str);
