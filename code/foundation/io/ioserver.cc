...
*/
bool
IoServer::MountMPQArchive(const URI& uri)
{
	Ptr<MPQArchive> mpqArchive = this->mpqFileSystem->Mount(uri);
	return mpqArchive.isvalid();
}
...
*/
void
IoServer::UnmountMPQArchive(const URI& uri)
{
