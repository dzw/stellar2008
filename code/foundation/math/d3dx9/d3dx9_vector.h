...
public:
	...
	/// transform
	static vector transformcoord(const vector& v, const matrix44& m);
    friend class point;
};
...
*/
__forceinline vector 
vector::transformcoord(const vector& v, const matrix44& m)
{
	vector res;
	D3DXVec3TransformCoord((D3DXVECTOR3*)&res, (CONST D3DXVECTOR3*)&v, (CONST D3DXMATRIX*)&m);
	return res;
}
} // namespace Math
//------------------------------------------------------------------------------
