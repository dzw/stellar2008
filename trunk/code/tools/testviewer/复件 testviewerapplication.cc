...
<<<<<<< .mine
  ...
  //      this->head->SetResourceId(ResourceId("mdl:characters/mensch_m.n2"));
...
>>>>>>> .r4
		...
		this->tree->SetResourceId(ResourceId("wow:Creature\\Ancientofarcane\\Ancientofarcane.m2"));
		this->stage->AttachEntity(this->tree.upcast<GraphicsEntity>());

		//this->view->SetFrameShader(FrameServer::Instance()->GetFrameShaderByName(ResourceId("DX9Sample")));

		this->worldManager = WorldManager::Create();
