//------------------------------------------------------------------------------
//  PhysX/MemoryAllocator.cc
//  (C) 2010
//------------------------------------------------------------------------------
#include "stdneb.h"
#include "core/debug.h"
#include "physx/memoryallocator.h"
#include "NxPhysics.h"
...
MemoryAllocator::MemoryAllocator() : mNbAllocatedBytes(0), mHighWaterMark(0), mTotalNbAllocs(0), mNbAllocs(0), mNbReallocs(0)
{
...
void* MemoryAllocator::malloc(size_t size, NxMemoryType type)
{
#ifdef _DEBUG
...
void* MemoryAllocator::mallocDEBUG(size_t size, const char* file, int line)
{
	printf("Obsolete code called!\n");
	return NULL;
}

void* MemoryAllocator::mallocDEBUG(size_t size, const char* file, int line, const char* className, NxMemoryType type)
{
#ifndef _DEBUG
...
void* MemoryAllocator::realloc(void* memory, size_t size)
	{
