#ifndef PHYSX_CHARACTERCONTROLMANAGER_H
#define PHYSX_CHARACTERCONTROLMANAGER_H
//------------------------------------------------------------------------------
/**
...
class CharControlManager : public Core::RefCounted
{
	DeclareClass(CharControlManager);
	DeclareSingleton(CharControlManager);
public:
	CharControlManager();
	~CharControlManager();
	void Open();
