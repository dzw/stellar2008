...
public:
	...
	///
	virtual bool HasManagedResource(const ResourceId& resId) const;
	///
	virtual const Ptr<ManagedResource>& LookupManagedResource(const ResourceId& resId) const;
...
protected:
	...
	Util::HashMap<Util::String, Ptr<ManagedResource>, Util::StringHasher> managedResources;
	Util::Array<Ptr<Resource> > pendingResources;
};
